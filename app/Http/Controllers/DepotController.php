...
class DepotController extends Controller
{
    ...
    public function index () {
        ...
        $depots=Depot::orderBy("intitule","asc")->simplePaginate(3);
    ...
    public function creer (Request $request) {
       ...
       try {
        ...
        return back()->with('success', 'Dépôt ajouté avec succès!');
    ...
    public function delete(Depot $depot)
    {
        ...
        return redirect()->route('accueil', ['page' =>1])->with('successDelete', 'Depot supprimé avec succès.');
    }
    public function update (Request $request ,Depot $depot) {
        ...
        $depot->update(
         ...
         return back()->with("success","Votre Depot/Magasin est a jour!");
     }
