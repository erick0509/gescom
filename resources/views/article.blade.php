    ...
    <section id="article-liste" class="article py-4 ">
        <div class="container">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-1">
                                        <input id="desi" class="form-control form-control-sm" type="search"
                                            placeholder="..." aria-label="Search" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form class="mt-2" method="post" action="{{ route('ajouter.article') }}">
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input id="designation" class="form-control form-control-sm" type="search"
                                                    placeholder="Désignation..." aria-label="Search">

                                                <!-- Liste déroulante des articles -->
                                                <select id="selectDesignation" class="form-select form-select-sm"
                                                    aria-label="ListeArticles" name="article_id">
                                                ...
                                                <!-- Bouton Ajouter -->
                                                <button class="btn btn-success btn-sm" type="submit" id="btnAjouterArticle"
                                                    disabled>
                                    ...
                                    <div class="col-md-4">
                                        <form class="mt-2" action="{{ route('import.article') }}" method="POST"
                    ...
                    <div class="input-group">
                        <div class="input-group-append">
                            <select class="form-select" aria-label="Filtrer par" name="filterBy">
                                <option value="designation" @if (isset($filterBy) && $filterBy == 'designation') selected @endif>Designation
                                </option>
                                <option value="quantiteEgal" @if (isset($filterBy) && $filterBy == 'quantiteEgal') selected @endif>Quantité
                                    égale à</option>
                                <option value="quantiteInferieur" @if (isset($filterBy) && $filterBy == 'quantiteInferieur') selected @endif>Quantité
                                    inférieur à</option>
                                <option value="quantiteSuperieur" @if (isset($filterBy) && $filterBy == 'quantiteSuperieur') selected @endif>Quantité
                                    supérieur à</option>
                            </select>
                        </div>
            ...
            @else
                            ...
                            @foreach ($articles as $article)
                                <tr style="font-size: 12px;">
                                    ...
                                    <td class="no-wrap" style="text-align: center;">
                                        <b>{{ $article->stocks->first()->quantiteDepot ?? 'Non disponible' }}</b></td>
                                    ...
                                    @foreach (range(0, 2) as $index)
                                        @if (isset($article->tarifs[$index]))
                                            ...
                                            <td class="no-wrap" style="text-align: center;">
                                                <b>[{{ $tarif->quantite_min }} -
                                                    {{ $tarif->quantite_max === 9999999 ? 'infini' : $tarif->quantite_max }}]</b>
                                            </td>
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center ">
                                            <form id="form-{{ $article->id }}"
                                                action="{{ route('detacher.article', $article->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                          ...
                                          data-tarif-quantite-max-{{ $index }}="{{ $tarif->quantite_max }}" @endforeach></a>
                                            @endif
                ...
                <a href="{{ route('articles.impression', ['codeValide' => $codeValide]) }}" target="_blank"
                    class="btn btn-primary mb-3"><i class="fas fa-print"></i> Imprimer</a>
            @endif <!-- DISPLAY NONE -->
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-2 col-12 mt-1">
                                <div class="input-group mt-1">
                                    ...
                                    <input type="number" class="form-control" id="inputPassword" name="prixAchatModif"
                                        step="0.01" required>
                                </div>
                            </div>

                            <label for="inputPassword" class="col-sm-2 col-form-label h4 mt-1">Quantité
                                disponnible:</label>
                            <div class="col-md-2 col-12 mt-1">
                                <input type="number" class="form-control" id="inputPassword" step="0.01"
                                    name="quantiteStockModif">
                            </div>
                                    ...
                                    <div class="border p-3">
                                        ...
                                        <div class="input-group mt-1">
                                            ...
                                            <input type="number" class="form-control" id="inputPassword"
                                                name="prixVenteModif1" placeholder="1500" step="0.01">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Min:</span>
                                            <input type="number" class="form-control" id="inputPassword" step="0.01"
                                                name="quantiteMinModif1" placeholder="1">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Max:</span>
                                            <input type="number" class="form-control" id="inputPassword" step="0.01"
                                                name="quantiteMaxModif1" placeholder="9">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border p-3">
                                        ...
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Prix:</span>
                                            <input type="number" class="form-control" id="inputPassword"
                                                name="prixVenteModif2" placeholder="1400" step="0.01">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Min:</span>
                                            <input type="number" class="form-control" id="inputPassword"step="0.01"
                                                name="quantiteMinModif2" placeholder="10">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Max:</span>
                                            <input type="number" class="form-control" id="inputPassword"
                                                step="0.01"name="quantiteMaxModif2" placeholder="29">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="border p-3">
                                        ...
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Prix:</span>
                                            <input type="number" class="form-control" id="inputPassword"
                                                name="prixVenteModif3" placeholder="1300" step="0.01">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Min:</span>
                                            <input type="number" class="form-control"step="0.01" id="inputPassword"
                                                name="quantiteMinModif3" placeholder="30">
                                        </div>
                                        <div class="input-group mt-1">
                                            <span for="inputPassword" class="input-group-text">Max:</span>
                                            <input type="number" class="form-control" step="0.01" id="inputPassword"
                                                name="quantiteMaxModif3" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            selectDesignation.addEventListener('change', function() {
                updateReadonlyState();
                inputDesi.value = selectDesignation.options[selectDesignation.selectedIndex]
                .text; // Mettre à jour l'input avec la sélection
            });
            updateReadonlyState();
        });
    </script>
