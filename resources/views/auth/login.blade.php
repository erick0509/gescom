        ...
        <form method="post" action="{{route('auth.login')}}" class="needs-validation" novalidate>
          ...
          <fieldset class="p-4">
            <div class="form-floating mb-3">
              <input type="text" class="form-control" id="floatingInput" placeholder="User" name="name" required
                value="{{old('name')}}">
            ...
            <div class="row justify-content-center">
              <button type="submit" class="btn btn-primary font-weight-bold mt-2 col-6"><i
                  class="fas fa-sign-in-alt me-1"></i>Se connecter</button>
            </div>
          </fieldset>
        </form>
