          ...
          <form method="post" action="{{route('auth.update')}}" class="needs-validation" novalidate>
            ...
            <fieldset class="p-4">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" placeholder="User" name="name" value="{{ session('name') }}" disabled>
                  ...
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="mots de passe" name="oldPassword" required>
                  ...
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="mots de passe" name="newPassword" required>
                  ...
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control" id="floatingPassword" placeholder="mots de passe" name="renewPassword" required>
